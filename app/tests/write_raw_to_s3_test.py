...
class DummySelf:
    def __init__(self):
        self.document_type = DocumentType.MASTER_DATA
        self.request_id = "req-123"
        self.project_name = "DKSH_TW"
        self.sap_masterdata = None
        ...
        self.tracking_model = TrackingModel(
            ...
            sap_masterdata=self.sap_masterdata,
        )
...
class TestWriteRawToS3(unittest.TestCase):
    ...
    @patch("fastapi_celery.processors.workflow_processors.write_raw_to_s3.StepOutput")
    @patch("fastapi_celery.processors.workflow_processors.write_raw_to_s3.get_context_value")
    ...
    @patch("fastapi_celery.processors.workflow_processors.write_raw_to_s3.StepOutput")
    @patch("fastapi_celery.processors.workflow_processors.write_raw_to_s3.get_context_value")
    @patch("fastapi_celery.processors.workflow_processors.write_raw_to_s3.read_n_write_s3.copy_object_between_buckets", side_effect=Exception("Mocked S3 error"))
    @patch("fastapi_celery.processors.workflow_processors.write_raw_to_s3.config_loader.get_config_value")
